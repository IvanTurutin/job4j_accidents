...
class AccidentJdbcTest {
    private static AccidentJdbc store;
    private static AccidentTypeJdbc typeStore;
    private static RuleJdbc ruleStore;
 ...
 */
        ...
        store = new AccidentJdbc(jdbc);
        typeStore = new AccidentTypeJdbc(jdbc);
        ruleStore = new RuleJdbc(jdbc);
